...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RecipeIngredient.unit'
        db.alter_column(u'recipes_recipeingredient', 'unit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.Unit'], null=True))

    def backwards(self, orm):

        # Changing field 'RecipeIngredient.unit'
        db.alter_column(u'recipes_recipeingredient', 'unit_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['recipes.Unit']))
